...
#define yyparse REF_parse
#define yylex   REF_lex
#define yyerror REF_error
#define yylval  REF_lval
#define yychar  REF_char
#define yydebug REF_debug
#define yynerrs REF_nerrs
...
{
      17,     0,    -1,    18,    -1,     9,    13,    19,    -1,     9,
      -1,    20,    -1,    19,    10,    20,    -1,     9,    12,    23,
      -1,     9,    12,    21,    -1,    14,    22,    15,    -1,    23,
      -1,    22,    10,    23,    -1,     4,    -1,     6,    -1,     8,
      -1,     5,    -1,    24,    -1,     3,    -1,     7,    -1,    24,
       7,    -1
};
...
{
       0,    63,    63,    70,    78,    89,    94,   103,   113,   126,
     134,   139,   148,   156,   164,   172,   180,   188,   198,   203
};
#endif
...
{
  "$end", "error", "$undefined", "REF_TOK_NULL_VALUE",
  "REF_TOK_INT_VALUE", "REF_TOK_BOOL_VALUE", "REF_TOK_REAL_VALUE",
  "REF_TOK_STRING_VALUE", "REF_TOK_CHAR_VALUE", "REF_TOK_IDENT",
  "REF_TOK_COMMA", "REF_TOK_COLON", "REF_TOK_EQUAL", "REF_TOK_DOT",
  "REF_TOK_OPEN_BRACE", "REF_TOK_CLOSE_BRACE", "$accept", "start",
  "model_path", "key_val_pair_list", "key_val_pair", "value_array",
  "value_list", "value", "multi_string", 0
};
#endif
...
{
       0,    -6,    10,   -12,     3,   -12,     9,    13,   -12,    -3,
       3,   -12,   -12,   -12,   -12,   -12,   -12,    12,   -12,   -12,
      15,   -12,    -2,   -12,   -12,    12,   -12,   -12
};

/* YYPGOTO[NTERM-NUM].  */
static const yysigned_char yypgoto[] =
{
     -12,   -12,   -12,   -12,    14,   -12,   -12,   -11,   -12
};
...
{
      11,    12,    13,    14,    15,    16,    23,     4,    25,     1,
       5,    17,     6,    26,    27,    11,    12,    13,    14,    15,
      16,     9,    24,    10,    21
};

static const unsigned char yycheck[] =
{
       3,     4,     5,     6,     7,     8,    17,    13,    10,     9,
       0,    14,     9,    15,    25,     3,     4,     5,     6,     7,
       8,    12,     7,    10,    10
};
...
{
       0,     9,    17,    18,    13,     0,     9,    19,    20,    12,
      10,     3,     4,     5,     6,     7,     8,    14,    21,    23,
      24,    20,    22,    23,     7,    10,    15,    23
};
...
#line 71 "REF.y"
	...
	(yyval.obj_ref) = new MOF_Object_Reference();
	MOF_ASSERT((yyval.obj_ref) != NULL);
	(yyval.obj_ref)->class_name = (yyvsp[-2].string_value);
	(yyval.obj_ref)->pairs = (yyvsp[0].key_val_pair);
    ;}
    break;
...
#line 79 "REF.y"
	...
	(yyval.obj_ref) = new MOF_Object_Reference();
	MOF_ASSERT((yyval.obj_ref) != NULL);
	(yyval.obj_ref)->class_name = (yyvsp[0].string_value);
	(yyval.obj_ref)->pairs = NULL;
    ;}
    break;
...
#line 90 "REF.y"
	...
	(yyval.key_val_pair) = (yyvsp[0].key_val_pair);
    ;}
    break;
...
#line 95 "REF.y"
	...
	(yyvsp[-2].key_val_pair)->append((yyvsp[0].key_val_pair));
	(yyval.key_val_pair) = (yyvsp[-2].key_val_pair);
    ;}
    break;
...
#line 104 "REF.y"
	...
	(yyval.key_val_pair) = new MOF_Key_Value_Pair();
	MOF_ASSERT((yyval.key_val_pair) != NULL);
	(yyval.key_val_pair)->key = (yyvsp[-2].string_value);
	(yyval.key_val_pair)->value = (yyvsp[0].literal);
	(yyval.key_val_pair)->is_array = false;
    ;}
    break;
...
#line 114 "REF.y"
	...
	(yyval.key_val_pair)->key = (yyvsp[-2].string_value);
	(yyval.key_val_pair)->value = (yyvsp[0].literal);
	(yyval.key_val_pair)->is_array = true;
    ;}
    break;
