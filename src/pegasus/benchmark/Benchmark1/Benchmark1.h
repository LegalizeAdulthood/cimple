...
#ifndef _cimple_Benchmark1_h
#define _cimple_Benchmark1_h
...
class Benchmark1 : public Instance
{
public:
    ...
    CIMPLE_CLASS(Benchmark1)
};

typedef CIM_PhysicalPackage_IsCompatible_method Benchmark1_IsCompatible_method;

typedef CIM_Card_ConnectorPower_method Benchmark1_ConnectorPower_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_Benchmark1_h */
