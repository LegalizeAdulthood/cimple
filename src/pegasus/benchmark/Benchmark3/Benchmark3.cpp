...
static Meta_Feature* _Benchmark3_meta_features[] =
{
...
const Meta_Class Benchmark3::static_meta_class =
{
    CIMPLE_FLAG_CLASS,
    "Benchmark3",
    _Benchmark3_meta_features,
    CIMPLE_ARRAY_SIZE(_Benchmark3_meta_features),
    sizeof(Benchmark3),
    _locals,
