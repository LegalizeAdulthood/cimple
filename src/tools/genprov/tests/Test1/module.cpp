...
static int __cimple_Test1_Provider_proc(
...
CIMPLE_MODULE(Test1_Module);
CIMPLE_INSTANCE_PROVIDER(Test1_Provider);
...
# define __CIMPLE_FOUND_ENTRY_POINT
  ...
  CIMPLE_CMPI_INSTANCE_PROVIDER(Test1_Provider);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_OPENWBEM_MODULE
  CIMPLE_OPENWBEM_PROVIDER(Test1_Module);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif
