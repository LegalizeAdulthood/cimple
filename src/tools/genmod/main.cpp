...
void gen_warning(FILE* os)
{
    ...
    fprintf(os, "//\n");
    fprintf(os, "// PLEASE DO NOT EDIT THIS FILE; "
        "IT WAS AUTOMATICALLY GENERATED BY GENMOD.\n");
    fprintf(os, "//\n");
    gen_comment_line(os, 80);
    fputc('\n', os);
}
...
CIMPLE_ID("$Header: /home/cvs/cimple/src/tools/genmod/main.cpp,v 1.7 2007/04/18 13:25:15 mbrasher-public Exp $");
