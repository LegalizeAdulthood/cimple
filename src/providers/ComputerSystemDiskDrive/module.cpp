...
static int __cimple_ComputerSystemDiskDrive_Provider_proc(
...
CIMPLE_MODULE(ComputerSystemDiskDrive_Module);
CIMPLE_ASSOCIATION_PROVIDER(ComputerSystemDiskDrive_Provider);
...
# define __CIMPLE_FOUND_ENTRY_POINT
  ...
  CIMPLE_CMPI_ASSOCIATION_PROVIDER(ComputerSystemDiskDrive_Provider);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_OPENWBEM_MODULE
  CIMPLE_OPENWBEM_PROVIDER(ComputerSystemDiskDrive_Module);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif
