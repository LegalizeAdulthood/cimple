...
class CIM_DiskDrive : public Instance
{
public:
    ...
    CIMPLE_CLASS(CIM_DiskDrive)
};

class CIM_DiskDrive_RequestStateChange_method : public Instance
{
public:
    Property<uint16> RequestedState;
    CIM_ConcreteJob* Job;
    ...
    CIMPLE_METHOD(CIM_DiskDrive_RequestStateChange_method)
};

class CIM_DiskDrive_SetPowerState_method : public Instance
{
public:
    Property<uint16> PowerState;
    Property<Datetime> Time;
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_SetPowerState_method)
};

class CIM_DiskDrive_Reset_method : public Instance
{
public:
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_Reset_method)
};

class CIM_DiskDrive_EnableDevice_method : public Instance
{
public:
    Property<boolean> Enabled;
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_EnableDevice_method)
};

class CIM_DiskDrive_OnlineDevice_method : public Instance
{
public:
    Property<boolean> Online;
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_OnlineDevice_method)
};

class CIM_DiskDrive_QuiesceDevice_method : public Instance
{
public:
    Property<boolean> Quiesce;
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_QuiesceDevice_method)
};

class CIM_DiskDrive_SaveProperties_method : public Instance
{
public:
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_SaveProperties_method)
};

class CIM_DiskDrive_RestoreProperties_method : public Instance
{
public:
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_RestoreProperties_method)
};

class CIM_DiskDrive_LockMedia_method : public Instance
{
public:
    Property<boolean> Lock;
    Property<uint32> return_value;
    CIMPLE_METHOD(CIM_DiskDrive_LockMedia_method)
};
