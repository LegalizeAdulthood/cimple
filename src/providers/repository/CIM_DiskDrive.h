...
#ifndef _cimple_CIM_DiskDrive_h
#define _cimple_CIM_DiskDrive_h
...
class CIMPLE_LINKAGE CIM_DiskDrive : public Instance
{
public:
...
typedef CIM_EnabledLogicalElement_RequestStateChange_method CIM_DiskDrive_RequestStateChange_method;

typedef CIM_LogicalDevice_SetPowerState_method CIM_DiskDrive_SetPowerState_method;

typedef CIM_LogicalDevice_Reset_method CIM_DiskDrive_Reset_method;

typedef CIM_LogicalDevice_EnableDevice_method CIM_DiskDrive_EnableDevice_method;

typedef CIM_LogicalDevice_OnlineDevice_method CIM_DiskDrive_OnlineDevice_method;

typedef CIM_LogicalDevice_QuiesceDevice_method CIM_DiskDrive_QuiesceDevice_method;

typedef CIM_LogicalDevice_SaveProperties_method CIM_DiskDrive_SaveProperties_method;

typedef CIM_LogicalDevice_RestoreProperties_method CIM_DiskDrive_RestoreProperties_method;

typedef CIM_MediaAccessDevice_LockMedia_method CIM_DiskDrive_LockMedia_method;

CIMPLE_NAMESPACE_END

#endif /* _cimple_CIM_DiskDrive_h */
