...
static int __cimple_SNIA_SpareConfigurationService_Provider_proc(
    ...
    void* arg7)
{
    ...
    {
        typedef SNIA_SpareConfigurationService_RebuildStorageExtent_method Method;
        Method* method = (Method*)arg2;
    ...
    {
        typedef SNIA_SpareConfigurationService_CheckParityConsistency_method Method;
        Method* method = (Method*)arg2;
...
CIMPLE_MODULE(SNIA_SpareConfigurationService_Module);
CIMPLE_INSTANCE_PROVIDER(SNIA_SpareConfigurationService_Provider);
  ...
  CIMPLE_OPENWBEM_PROVIDER(SNIA_SpareConfigurationService_Module);
#endif
