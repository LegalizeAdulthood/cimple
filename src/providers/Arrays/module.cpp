...
static int __cimple_Arrays_Provider_proc(
...
CIMPLE_MODULE(Arrays_Module);
CIMPLE_INSTANCE_PROVIDER(Arrays_Provider);
...
# define __CIMPLE_FOUND_ENTRY_POINT
  ...
  CIMPLE_CMPI_INSTANCE_PROVIDER(Arrays_Provider);
  CIMPLE_CMPI_INSTANCE_PROVIDER2(Arrays_Provider, Arrays);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_OPENWBEM_MODULE
  CIMPLE_OPENWBEM_PROVIDER(Arrays_Module);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_WMI_MODULE
# include "guid.h"
  CIMPLE_WMI_PROVIDER_ENTRY_POINTS(CLSID_Arrays_Module)
# define __CIMPLE_FOUND_ENTRY_POINT
#endif
