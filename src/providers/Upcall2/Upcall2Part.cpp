...
static Meta_Feature* _Upcall2Part_MFA[] =
{
...
const Meta_Class Upcall2Part::static_meta_class =
{
    { 0 }, /* refs */
    CIMPLE_FLAG_CLASS,
    "Upcall2Part",
    ...
    _Upcall2Part_MFA,
    CIMPLE_ARRAY_SIZE(_Upcall2Part_MFA),
    sizeof(Upcall2Part),
    _locals,
...
CIMPLE_ID("$Header: /home/cvs/cimple/src/providers/Upcall2/Upcall2Part.cpp,v 1.4 2007/03/07 20:25:29 mbrasher-public Exp $");
