...
static int __cimple_Thing_Provider_proc(
...
static int __cimple_ThingLink_Provider_proc(
    const Registration* registration,
    int operation,
    void* arg0,
    void* arg1,
...
CIMPLE_INSTANCE_PROVIDER(Thing_Provider);
CIMPLE_ASSOCIATION_PROVIDER(ThingLink_Provider);
...
# define __CIMPLE_FOUND_ENTRY_POINT
  ...
  CIMPLE_OPENWBEM_PROVIDER(Thing_Module);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif
