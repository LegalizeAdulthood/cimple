...
static int __cimple_cmpl_test_Provider_proc(
    ...
    void* arg7)
{
    ...
    typedef cmpl_test_Provider Provider;
    ...
    {
        typedef cmpl_test_foo_method Method;
...
CIMPLE_MODULE(cmpl_test_Module);
CIMPLE_INSTANCE_PROVIDER(cmpl_test_Provider);
...
# define __CIMPLE_FOUND_ENTRY_POINT
  ...
  CIMPLE_CMPI_INSTANCE_PROVIDER(cmpl_test_Provider);
  CIMPLE_CMPI_INSTANCE_PROVIDER2(cmpl_test_Provider, cmpl_test);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_OPENWBEM_MODULE
  CIMPLE_OPENWBEM_PROVIDER(cmpl_test_Module);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_WMI_MODULE
# include "guid.h"
  CIMPLE_WMI_PROVIDER_ENTRY_POINTS(CLSID_cmpl_test_Module)
# define __CIMPLE_FOUND_ENTRY_POINT
#endif
