...
static int __cimple_Place_Provider_proc(
...
{
    typedef Place Class;
    typedef Place_Provider Provider;
    ...
    {
        typedef Place_foo_method Method;
...
CIMPLE_MODULE(Place_Module);
CIMPLE_INSTANCE_PROVIDER(Place_Provider);
...
# define __CIMPLE_FOUND_ENTRY_POINT
  ...
  CIMPLE_CMPI_INSTANCE_PROVIDER(Place_Provider);
  CIMPLE_CMPI_INSTANCE_PROVIDER2(Place_Provider, Place);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_OPENWBEM_MODULE
  CIMPLE_OPENWBEM_PROVIDER(Place_Module);
# define __CIMPLE_FOUND_ENTRY_POINT
#endif

#ifdef CIMPLE_WMI_MODULE
# include "guid.h"
  CIMPLE_WMI_PROVIDER_ENTRY_POINTS(CLSID_Place_Module)
# define __CIMPLE_FOUND_ENTRY_POINT
#endif
