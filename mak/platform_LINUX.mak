...
make_shlib = \
    ...
    $(call _full_libs,$(3)) \
    $(_SYS_LIBS) $(NL) \
    ( cd $(LIB); ln -f -s lib$(1).so.1 lib$(1).so )
...
shlib_clean_targets = $(call shlib_target,$(1)) $(call shlib_link,$(1))
